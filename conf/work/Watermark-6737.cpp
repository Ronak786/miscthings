...
int main(int argc, char** argv)
{
	...
	para[0] = 1;
	ret = pthread_create(&tidT2, NULL, &DisplayText, para);
	usleep(200*1000);

	para[0] = 3;
	ret = pthread_create(&tidT3, NULL, &DisplayText, para);
	usleep(200*1000);
    */
...
static void* DisplayText(void *para){
    ...
    sp<SurfaceControl> surfaceControl = client->createSurface(String8("testsurface"), textWidth, textSize, PIXEL_FORMAT_RGB_565, 0);
    ...
    if (((char*)para)[0] == 1) {
        surfaceControl->setPosition(720-textWidth-10, 1280-textSize-10);
    } else if (((char*)para)[0] == 2) {
        surfaceControl->setPosition(0, 1280-textSize-10);
    } else {
...
static void* DisplayImage(void *para) {
    ...
    if (((char*)para)[0] == 2) {
        surfaceControl->setPosition(0, 1280-imageInfo.height-10);
    } else {
