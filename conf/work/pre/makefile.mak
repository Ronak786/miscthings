...
# used for ssl library
DEFINE			 += -DWOLFSSL_USER_SETTINGS -DUSER_MATH_LIB -DUSER_TIME -DTIME_OVERRIDES -DWOLFSSL_DH_CONST -DXMALLOC_USER
...
INCLUDE_FILE     =  \
    ...
    -I$(MTK_PATH_PLATFORM)/src/security/inc \
    -I$(MTK_PATH_PLATFORM)/src/kivvisecurity \
    -I$(MTK_PATH_PLATFORM)/src/preloader_security \
    -I$(EMIGEN_OUT)/inc \
